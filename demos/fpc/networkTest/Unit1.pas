...
uses
  Classes, SysUtils, LResources, Forms, StdCtrls, ExtCtrls, Graphics,
  nxNetwork;
...
procedure TForm1.ServerData(sender: TConnection; data: PByte; size,ID: integer);
var s: string;
begin
...
procedure TForm1.ClientData(sender: TConnection; data: PByte; size,ID: integer);
var s: string;
begin
...
begin
  ...
  while ServerThreads+ClientThreads>0 do begin
